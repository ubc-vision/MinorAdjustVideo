...
We propose differentiable box optimization method that aligns user-provided boxes to the model's internal understanding while balancing foreground and background. -->
